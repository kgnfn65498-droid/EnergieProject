...
def test_current_changelog_preserves_smp_report_fallback_history():
    ...
    assert changelog.startswith("## v32.3.1 — Kwartierdata, NextEnergy-contractmodel en gesprekspartner")
...
def test_current_addon_changelog_is_current_release_only():
    ...
    assert "## 32.3.1 - Kwartierdata, NextEnergy-contractmodel en gesprekspartner" in changelog
