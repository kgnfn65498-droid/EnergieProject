...
def test_current_changelog_preserves_smp_report_fallback_history():
    ...
    assert changelog.startswith("## v32.1.3 — SMP maandtotalen uit meterstandgrenzen")
...
def test_current_addon_changelog_is_current_release_only():
    ...
    assert "## 32.1.3 - Betrouwbare SMP maandtotalen voor Energiehistorie Excel" in changelog
