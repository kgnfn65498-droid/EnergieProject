...
def test_32425_release_identity_and_core_boundary():
    ...
    assert 'TARGET_RELEASE_VERSION = "32.4.36"' in mode
    assert (APP / "projectmanager_v2/VERSION.txt").read_text(encoding="utf-8").strip() == "2.0.0-rc23"
...
def test_32425_current_release_contract_and_changelog():
    ...
    assert root_log.startswith("## 32.4.36")
