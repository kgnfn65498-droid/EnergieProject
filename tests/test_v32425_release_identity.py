...
def test_32425_release_identity_and_core_boundary():
    ...
    assert 'APP_VERSION = "32.4.30"' in main
    assert 'PRODUCTION_CORE_REVISION = "9.4-core3"' in main
    assert 'TARGET_RELEASE_VERSION = "32.4.30"' in mode
...
def test_32425_current_release_contract_and_changelog():
    ...
    assert contract.CURRENT_RELEASE == "32.4.30"
    ...
    assert root_log.startswith("## 32.4.30")
