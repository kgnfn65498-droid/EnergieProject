...
def test_32428_release_identity_is_synchronized():
    ...
    assert contract.CURRENT_RELEASE == "32.4.42"
    assert contract.CURRENT_PM_VERSION == "2.0.0-rc29"
    assert (APP / "projectmanager_v2/VERSION.txt").read_text(encoding="utf-8").strip() == "2.0.0-rc29"
...
def test_32428_changelog_describes_pm_observation_dependency_fix():
    ...
    assert root_log.startswith('## 32.4.42')
