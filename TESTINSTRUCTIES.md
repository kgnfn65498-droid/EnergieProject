# Testinstructies v32.0.4 — NAS-layoutcorrectie

1. Plaats `EnergieProject_v32.0.4.zip` in `EnergieProject/Inbox/incoming` en wacht tot de release in `EnergieProject/Inbox/processed` staat.
2. Update SlimmeMeterPortal Import in Home Assistant en controleer dat versie `32.0.4` zichtbaar is.
...
6. Controleer dat analyse-export `version = 32.0.4` meldt en dat bestaande financiële/rapportagegates ongewijzigd blijven.
