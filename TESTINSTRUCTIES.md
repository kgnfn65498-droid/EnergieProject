# Testinstructies v32.2.2 — Knowledge Base
...
- Update naar 32.2.2 via de normale NAS → GitHub → Home Assistant-keten.
...
## Home Assistant na installatie
- Update naar 32.2.2 moet via de normale NAS → GitHub → Home Assistant-keten verschijnen.
