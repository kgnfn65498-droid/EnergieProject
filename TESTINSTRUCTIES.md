# Testinstructies v32.0.8 — NAS-layoutcorrectie

1. Plaats `EnergieProject_v32.0.8.zip` in `EnergieProject/Inbox/incoming` en wacht tot de release in `EnergieProject/Inbox/processed` staat.
2. Update SlimmeMeterPortal Import in Home Assistant en controleer dat versie `32.0.8` zichtbaar is.
...
6. Controleer dat analyse-export `version = 32.0.8` meldt en dat bestaande financiële/rapportagegates ongewijzigd blijven.
...
11. Controleer dat analyse-export `validation_marker = v32_0_8_runtime_identity` meldt.
