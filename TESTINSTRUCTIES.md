# Testinstructies v32.0.5 — NAS-layoutcorrectie

1. Plaats `EnergieProject_v32.0.5.zip` in `EnergieProject/Inbox/incoming` en wacht tot de release in `EnergieProject/Inbox/processed` staat.
2. Update SlimmeMeterPortal Import in Home Assistant en controleer dat versie `32.0.5` zichtbaar is.
...
6. Controleer dat analyse-export `version = 32.0.5` meldt en dat bestaande financiële/rapportagegates ongewijzigd blijven.
...
11. Controleer dat analyse-export `validation_marker = v32_0_4_runtime_identity` meldt.
