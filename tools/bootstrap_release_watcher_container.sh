...
if [ -d "/share/AI Projecten/EnergieProject" ]; then
  HOST_SHARE="/share/AI Projecten"
elif [ -d "/share/Energie_NAS/EnergieProject" ]; then
  HOST_SHARE="/share/Energie_NAS"
else
  echo "FOUT: EnergieProject-share niet gevonden" >&2
  exit 1
fi

INBOX="$HOST_SHARE/EnergieProject_Inbox"
